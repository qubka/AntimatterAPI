...
public class TileEntityDigitalTransformer extends TileEntityTransformer {
    ...
    @Override
    public void drawInfo(MatrixStack matrixStack, FontRenderer renderer, int left, int top) {
        // TODO: Replace by new TranslationTextComponent()
        renderer.drawString(matrixStack, "Control Panel", left + 43, top + 21, 16448255);
        renderer.drawString(matrixStack, "VOLT: " + voltage, left + 43, top + 40, 16448255);
        renderer.drawString(matrixStack, "TIER: " + Tier.getTier(voltage < 0 ? -voltage : voltage).getId().toUpperCase(), left + 43, top + 48, 16448255);
        renderer.drawString(matrixStack, "AMP: " + amperage, left + 43, top + 56, 16448255);
        renderer.drawString(matrixStack, "SUM: " + (long)(amperage * voltage), left + 43, top + 64, 16448255);
    }
}
