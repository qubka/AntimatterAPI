    ...
    public static void onItemTooltip(ItemTooltipEvent e) {
        if (e.getFlags().isAdvanced() && Ref.SHOW_ITEM_TAGS) {
            ...
            if (!tags.isEmpty()) {
                ...
                list.add(new StringTextComponent("Tags:"));//.setStyle(Style.EMPTY.setFormatting(TextFormatting.DARK_GRAY));
                for (ResourceLocation loc : tags) {
                    list.add(new StringTextComponent(loc.toString()));//.setStyle(Style.EMPTY.setFormatting(TextFormatting.DARK_GRAY));
                }
            }
        }
    }
