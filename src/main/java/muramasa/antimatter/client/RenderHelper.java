...
//    }
    ...
    public static void drawFluid(Minecraft mc, MatrixStack matrixStack, int posX, int posY, int width, int height, int scaledAmount, FluidStack stack) {
        ...
        if (stack.getAmount() >= 2000) {
            ...
            mc.fontRenderer.drawStringWithShadow(matrixStack, amount, posX + (16 - mc.fontRenderer.getStringWidth(amount) + 1), posY + 9, 0xFFFFFF);
        }
