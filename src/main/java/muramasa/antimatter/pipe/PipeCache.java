...
public class PipeCache {
    ...
    public static void update(PipeType<?> type, World world, Direction direction, TileEntity target, Cover cover) {
    ...
    public static void remove(PipeType<?> type, World world, Direction direction, TileEntity target) {
        DimensionEntry entry = LOOKUP.computeIfAbsent(world.getDimensionKey(), e -> new DimensionEntry());
