...
public abstract class AntimatterFeature<F extends IFeatureConfig> extends Feature<F> implements IAntimatterObject {
    ...
    Object2ObjectOpenHashMap<RegistryKey<World>, List<WorldGenBase<?>>> REGISTRY = new Object2ObjectOpenHashMap<>();

    public AntimatterFeature(Codec<F> configFactory, @Nullable Class<?> c) {
        super(configFactory);
    ...
    public Object2ObjectOpenHashMap<RegistryKey<World>, List<WorldGenBase<?>>> getRegistry() {
        return REGISTRY;
    }
}
